...
7. `test_anti_spoof_official_ensemble.py` - Kiểm tra Ensemble đa mô hình MiniFASNet
8. `test_head_movement.py` - Thử thách cử động đầu Active Liveness
9. `test_pipeline_full.py` - Toàn bộ chu trình eKYC tương tác & xuất báo cáo
