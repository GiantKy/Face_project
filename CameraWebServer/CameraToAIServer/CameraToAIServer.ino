...
// Endpoint Thử Thách Bước 1: Khởi tạo phiên liveness đa bước (QVGA 320x240 sáng rõ, pixel binning)
...
bool initCamera() {
  ...
  if (psramFound()) {
    config.frame_size   = FRAMESIZE_240X240; // 240x240 tỉ lệ 1:1 siêu nét, binning sáng rõ, FPS cao
...
void setup() {
  ...
  Serial.println("\n========================================================");
  Serial.println("  ESP32-S3 CAM: SNAPSHOT & MULTI-STAGE eKYC (240x240)");
  Serial.println("========================================================");
